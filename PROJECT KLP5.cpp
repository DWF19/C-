...
struct pelanggan {
   ...
   int meja;
   int totalbeli;
   void inputPelanggan(string nama, char gen, int meja) {
      this->nama = nama;
      this->gen = gen;
      this->meja = meja;
   }
...
void identitas() {
   ...
   int inputMeja;
   tambahdata();
    cout<<"\n\t\t=================== SELAMAT DATANG DI RUMAH MAKAN BERKAH ===================\n";
   cout << "\nMasukkan nama anda :";
   getline(cin>>ws,inputNama);
   cout << "\nGender anda (L/P)? :";
   cin >> inputGen;
   cout<< "\n*silahkan masukkan '0' jika TAKE AWAY" << endl;
   cout<< "Masukkan nomor meja :"; 
   cin >> inputMeja;
   tail->inputPelanggan(inputNama, inputGen, inputMeja);
   system("cls");
   makanan_utama();
}
void daftarpelanggan(){
   ...
   while(curr!=NULL){
      ...
      cout<<"Nomor Meja	: "<<curr->meja<<endl;
...
void menu_utama(){
   ...
   case 3:
   	system("cls");
			...
			cout<<"\t\t                          MENERIMA PESANAN                         \n";
			cout<<"\t\t                      WHATSAPP : +62 8980 1101 14                  \n";
			cout<<"\t\t===================================================================\n";
      return;
   default:
      break;
      ...
      uang -= kurang;
         ...
         if(uang == 0){
            cout<<"\n================== Terima Kasih Telah Belanja di Rumah Makan Kami ==================";
              ...
              if(kurang > uang ){
               kurang-=uang;
               cout<<"kembalian anda :"<<kurang<<endl;
